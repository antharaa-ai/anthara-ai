...
function Card({ reason, i, total, progress }: CardProps) {
  // Each card scales down as scroll progresses past it
  // Card 0 shrinks the most, last card never shrinks
    ...
    <div className="py-4 md:h-screen md:sticky md:top-0 flex items-center justify-center">
      <motion.div
        style={{
          ...
          // Visual offset so you can see cards stacking beneath
        }}
        className="
group
relative
...
hover:shadow-[0_0_80px_rgba(255,255,255,0.05)]
"
      ><div
          className={`
    absolute
...
export default function WhyAnthara() {
  ...
  return (
    ...
    "
      ...
      {/*
        Container ref for useScroll.
        Each card is h-screen and sticky top-0 inside here.
